...
def credit():
    while True:
        ...
        mouse=pygame.mouse.get_pos()
        click=pygame.mouse.get_pressed()
        if button("Back",mouse[0],mouse[1],w/2-100,700,200,50,grey,black,25,20):
            main()
...
def main():
    ...
    while menu:
        ...
        GD.blit(menubg,(0,0))
        button("Play",mouse[0],mouse[1],(w/2-100),4*h/7,200,100,grey,black,60,1)

        button("Quit",mouse[0],mouse[1],(w/2-100),(4*h/7)+180,200,100,grey,black,60,0)

        mouse=pygame.mouse.get_pos()
        if button2("Mute Music",mouse[0],mouse[1],288,250,200,50,grey,black,25):
            pygame.mixer.music.pause()
        if button2("Play Music",mouse[0],mouse[1],588,250,200,50,grey,black,25):
            pygame.mixer.music.unpause()
        if button2("Credits",mouse[0],mouse[1],888,250,200,50,grey,black,25):
            credit()
...
def options():
    ...
    while flag==True:
        ...
        #Back button
        b5=button("Back",mouse[0],mouse[1],50,650,200,50,grey,black,30,5)
        if b5==5:
            main()
        if b1=="s":
            play(21)
